...
# print the number of subscribers who have either english or french subscription
no_of_subscribers = list_english_news_subscribers.symmetric_difference(list_french_news_subscribers)
